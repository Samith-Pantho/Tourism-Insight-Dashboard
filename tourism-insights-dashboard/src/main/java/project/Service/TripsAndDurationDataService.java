...
public class TripsAndDurationDataService extends StatisticsFinlandDataService implements IDataService<TripDataAndDuration> {
    ...
    /**
     * Processes data fetched from the StatisticsFinland API.
     * Converts the JSON response into a list of TripDataAndDuration objects.
     */
    @Override
    ...
    /**
     * Filters the list of TripDataAndDuration objects by the specified year.
     */
    @Override
