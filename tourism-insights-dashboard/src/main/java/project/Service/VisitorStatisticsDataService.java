...
public class VisitorStatisticsDataService extends StatisticsFinlandDataService implements IDataService<VisitorStatistics>{
    ...
    /**
     * Processes the raw JSON data fetched from the API into a list of VisitorStatistics objects.
     * @return a list of VisitorStatistics objects representing the processed data.
     */
    @Override
    ...
    /**
     * Filters the list of VisitorStatistics objects by a specific trip type.
     */
    @Override
    ...
    /**
     * Aggregates visitor percentages by age group for a specific trip type.
     */
